...
소아과 폐과 등의 이슈로 아이가 아플 때 쉽게 병원을 찾기 힘든 부모를 위해 소아청소년과 병원의 실시간 온라인 접수 서비스를 제공하는 플랫폼

# 💡 Topic
* JWT 방식을 통한 회원(유저, 병원) 관리
* 병원 페이지를 별도 구현하여 유저의 전반적인 접수 관리 기능 구현
* 유저 페이지를 별도 구현하여 진료 예약 및 병원 정보 확인 가능 구현
* 진료가 완료될 시, 유저는 후기 작성하여 병원에 대한 평가를 할 수 있고 무조건 진료를 완료해야 후기 작성을 할 수 있으므로 병원에 대한 신뢰도를 알 수 있도록 기능 구현

# 📝 Summary
의원급 1차 병원의 경우 자체적인 웹 서비스를 구축할 수 없으므로 이를 위해 맞춤 예약 서비스 제공하고자 하였습니다.<br>

그리고 유저는 병원 후기 정보 및 실시간 대기자 수를 미리 알도록 하여 병원(의료 서비스) 접근성 향상을 위해 신경썼습니다.

# ⭐️ Key Function
* 매일게시판
  * 공지게시판, 자유게시판, 질문게시판등 다양한 게시판을 통해 게시판의 기능을 사용할 수 있음.
  
* 매일몰
  * 직장인들의 창의성을 발휘하여 매일몰에 상품을 등록하고 매일데이에서 대행 판매할 수 있음
